...
class VaccinationTracker {
  ...
  bindEvents() {
    ...
    if (this.manageProfilesBtn) {
      this.manageProfilesBtn.addEventListener('click', (e) => {
        e.preventDefault();
        // Navigate to Flask dashboard page instead of inline rendering
        window.location.href = '/dashboard';
      });
    }
    if (this.backToScheduleBtn) {
      this.backToScheduleBtn.addEventListener('click', (e) => {
        e.preventDefault();
        // Navigate back to home (schedule) page
